...
class CodeGenerator:
    ...
    def assemble_python_code(
        ...
        Args:
            ...
            workflow_data (Dict): The original workflow data for metadata preservation.
        ...
        static_imports = (
            ...
            + [
                ...
                (
                    "extra_pnginfo = "
                    '{"workflow": {"source": "workflow_api", "payload": json.loads('
                    + json.dumps(json.dumps(workflow_data))
                    + ")}}"
                ),
            ]
        )
...
class ComfyUItoPython:
    ...
    def execute(self):
        ...
        generated_code = code_generator.generate_workflow(
            load_order, data, queue_size=self.queue_size
        )
